...
(function($) {
	...
	//emw: following is custom
	plot.setToResizing = function() { options.legend.resizing = true; return;};
	
	// emw: following functions are default
	...
	//alert(res.x1)
	    ...
	    //alert('flot.js, insertLegend, options.legend.resizing = ' + options.legend.resizing + '\n flot.js, insertLegend, options.pan.framerate = ' + options.pan.framerate);
	    // emw: inserting special behavior for zooming/panning
	    //alert('flot.js, insertLegend, options.pan.framerate = ' + options.pan.framerate);
	    if (options.legend.resizing){
		//alert('resizing');
		return;
	    }
	    //alert('not resizing')
